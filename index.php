...
<section id="portfolio" class="portfolio">
  <div class="container">
    ...
    <div class="row portfolio-container">
      <?php
      $portfolio = "SELECT portfolio.*, category.name as category_name 
                    FROM `portfolio` 
                    JOIN `category` ON portfolio.category = category.id";
      ...
      if ($portfolio_result->num_rows > 0) {
        while ($portfolio_data = $portfolio_result->fetch_assoc()) {
          ?>
          <div class="col-lg-4 col-md-6 portfolio-item <?= $portfolio_data['category_name'] ?>">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <div class="portfolio-links">
                  ...
                  <a href="portfolio-details.php?id=<?= $portfolio_data['id'] ?>"
...
<div class="container contact-container">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" role="form" class="contact-form">
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="subject" id="subject" placeholder="Number" required>
        </div>
        <div class="form-group">
